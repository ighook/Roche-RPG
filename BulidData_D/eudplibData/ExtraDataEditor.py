...
def onPluginStart():
    ...
    DoActions([
        ...
        SetMemoryXEPD(WireOffset + 31, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 32, SetTo, 564398365),
        SetMemoryXEPD(WireOffset + 33, SetTo, 0, 0xFFFF),
    ])
    ...
    DoActions([
        SetMemory(0x5188DC, SetTo, btnptr20),
