...
def onPluginStart():
    ...
    DoActions([
        SetMemoryXEPD(WireOffset + 1, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 2, SetTo, 564398365),
        ...
        SetMemoryXEPD(WireOffset + 33, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 34, SetTo, 564398365),
        SetMemoryXEPD(WireOffset + 35, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(WireOffset + 41, SetTo, 100663296, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 42, SetTo, 328152384),
        SetMemoryXEPD(WireOffset + 43, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(WireOffset + 199, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 200, SetTo, 564398365),
        SetMemoryXEPD(WireOffset + 201, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(WireOffset + 201, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(WireOffset + 202, SetTo, 564398365),
        SetMemoryXEPD(WireOffset + 203, SetTo, 0, 0xFFFF),
    ])
    GrpOffset = f_epdread_epd(EPD(0x68C1FC))
    DoActions([
        SetMemoryXEPD(GrpOffset + 1, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(GrpOffset + 2, SetTo, 228722973),
        ...
        SetMemoryXEPD(GrpOffset + 33, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(GrpOffset + 34, SetTo, 228722973),
        SetMemoryXEPD(GrpOffset + 35, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(GrpOffset + 41, SetTo, 50331648, 0xFFFF0000),
        SetMemoryEPD(GrpOffset + 42, SetTo, 142482464),
        SetMemoryXEPD(GrpOffset + 43, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(GrpOffset + 199, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(GrpOffset + 200, SetTo, 228722973),
        SetMemoryXEPD(GrpOffset + 201, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(GrpOffset + 201, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(GrpOffset + 202, SetTo, 228722973),
        SetMemoryXEPD(GrpOffset + 203, SetTo, 0, 0xFFFF),
    ])
    tranOffset = f_epdread_epd(EPD(0x68C1F4))
    DoActions([
        SetMemoryXEPD(tranOffset + 1, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(tranOffset + 2, SetTo, 293931293),
        ...
        SetMemoryXEPD(tranOffset + 33, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(tranOffset + 34, SetTo, 293931293),
        SetMemoryXEPD(tranOffset + 35, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(tranOffset + 41, SetTo, 83886080, 0xFFFF0000),
        SetMemoryEPD(tranOffset + 42, SetTo, 129381664),
        SetMemoryXEPD(tranOffset + 43, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(tranOffset + 199, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(tranOffset + 200, SetTo, 293931293),
        SetMemoryXEPD(tranOffset + 201, SetTo, 0, 0xFFFF),
        SetMemoryXEPD(tranOffset + 201, SetTo, 83951616, 0xFFFF0000),
        SetMemoryEPD(tranOffset + 202, SetTo, 293931293),
        SetMemoryXEPD(tranOffset + 203, SetTo, 0, 0xFFFF),
    ])
    DoActions([ # 스테이터스인포메이션
    ])
    # 버튼셋
    bytebuffer = bytearray([2,0,255,0,208,130,66,0,112,51,66,0,0,0,0,0,156,2,0,0,3,0,230,0,48,143,66,0,128,67,66,0,0,0,0,0,154,2,0,0])
...
def beforeTriggerExec():
    DoActions([
        ...
        SetMemory(0x660A70 + 4, SetTo, 1048587),
        SetMemory(0x660A70 + 8, SetTo, 1441792),
        SetMemory(0x660A70 + 12, SetTo, 1900544),
        SetMemory(0x660A70 + 16, SetTo, 2555938),
        SetMemory(0x660A70 + 20, SetTo, 3080192),
        SetMemory(0x660A70 + 24, SetTo, 54),
        SetMemory(0x660A70 + 28, SetTo, 62),
        SetMemory(0x660A70 + 32, SetTo, 67),
        ...
        SetMemory(0x660A70 + 64, SetTo, 77),
        SetMemory(0x660A70 + 68, SetTo, 83),
        SetMemory(0x660A70 + 72, SetTo, 5898240),
        SetMemory(0x660A70 + 76, SetTo, 6422622),
        SetMemory(0x660A70 + 80, SetTo, 6684672),
        SetMemory(0x660A70 + 84, SetTo, 7077993),
        SetMemory(0x660A70 + 88, SetTo, 7798899),
        SetMemory(0x660A70 + 92, SetTo, 8323195),
        SetMemory(0x660A70 + 96, SetTo, 0),
        SetMemory(0x660A70 + 100, SetTo, 134),
        SetMemory(0x660A70 + 104, SetTo, 0),
        SetMemory(0x660A70 + 108, SetTo, 0),
        SetMemory(0x660A70 + 112, SetTo, 0),
        SetMemory(0x660A70 + 116, SetTo, 138),
        SetMemory(0x660A70 + 120, SetTo, 9896083),
        SetMemory(0x660A70 + 124, SetTo, 156),
        SetMemory(0x660A70 + 128, SetTo, 10813601),
        SetMemory(0x660A70 + 132, SetTo, 11272360),
        SetMemory(0x660A70 + 136, SetTo, 11534336),
        SetMemory(0x660A70 + 140, SetTo, 11927731),
        SetMemory(0x660A70 + 144, SetTo, 12452026),
        SetMemory(0x660A70 + 148, SetTo, 0),
        SetMemory(0x660A70 + 152, SetTo, 0),
        SetMemory(0x660A70 + 156, SetTo, 0),
        SetMemory(0x660A70 + 160, SetTo, 0),
        SetMemory(0x660A70 + 164, SetTo, 12910592),
        SetMemory(0x660A70 + 168, SetTo, 13435081),
        ...
        SetMemory(0x660A70 + 196, SetTo, 13893632),
        SetMemory(0x660A70 + 200, SetTo, 217),
        SetMemory(0x660A70 + 204, SetTo, 14548992),
        SetMemory(0x660A70 + 208, SetTo, 0),
        SetMemory(0x660A70 + 212, SetTo, 15204580),
        SetMemory(0x660A70 + 216, SetTo, 15991022),
        SetMemory(0x660A70 + 220, SetTo, 16515320),
        SetMemory(0x660A70 + 224, SetTo, 17170689),
        SetMemory(0x660A70 + 228, SetTo, 17826059),
        SetMemory(0x660A70 + 232, SetTo, 18481429),
        SetMemory(0x660A70 + 236, SetTo, 287),
        SetMemory(0x660A70 + 240, SetTo, 292),
        SetMemory(0x660A70 + 244, SetTo, 19792169),
        SetMemory(0x660A70 + 248, SetTo, 20447539),
        SetMemory(0x660A70 + 252, SetTo, 0),
        SetMemory(0x660A70 + 256, SetTo, 0),
        SetMemory(0x660A70 + 260, SetTo, 20774912),
        SetMemory(0x660A70 + 264, SetTo, 21365057),
        SetMemory(0x660A70 + 268, SetTo, 22020427),
        SetMemory(0x660A70 + 272, SetTo, 22675797),
        SetMemory(0x660A70 + 276, SetTo, 23527775),
        SetMemory(0x660A70 + 280, SetTo, 24576370),
        SetMemory(0x660A70 + 284, SetTo, 25821567),
        SetMemory(0x660A70 + 288, SetTo, 398),
        SetMemory(0x660A70 + 292, SetTo, 402),
        SetMemory(0x660A70 + 296, SetTo, 26607616),
        SetMemory(0x660A70 + 300, SetTo, 0),
        SetMemory(0x660A70 + 304, SetTo, 0),
        SetMemory(0x660A70 + 308, SetTo, 27001241),
        SetMemory(0x660A70 + 312, SetTo, 27460000),
        SetMemory(0x660A70 + 316, SetTo, 27656192),
        SetMemory(0x660A70 + 320, SetTo, 426),
        SetMemory(0x660A70 + 324, SetTo, 28443054),
        SetMemory(0x660A70 + 328, SetTo, 28967350),
        SetMemory(0x660A70 + 332, SetTo, 29491646),
        SetMemory(0x660A70 + 336, SetTo, 29753344),
        SetMemory(0x660A70 + 340, SetTo, 30343626),
        SetMemory(0x660A70 + 344, SetTo, 467),
